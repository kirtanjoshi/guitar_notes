...
class FormWidget extends StatelessWidget {
  const FormWidget({
    ...
    required ChordsController controller,
    ...
    required this.lyricsFocusNode,
        ...
        _chordController = controller;

  final GlobalKey<FormState> _formKey;
  final ChordsController _chordController;
        ...
        child: Column(
          children: [
            Column(
              children: [
                TextFormField(
                    controller: _chordController.title,
                ...
                TextFormField(
                    controller: _chordController.artist,
                ...
                TextFormField(
                    controller: _chordController.capo,
                ...
                TextFormField(
                  controller: _chordController.strummingPattern,
            ...
            Expanded(
              child: TextFormField(
                  controller: _chordController.chords,
